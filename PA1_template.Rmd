...
```{r loadblock, echo=TRUE, eval=TRUE}
...
```{r histogram1block, echo=TRUE, eval=TRUE}
library(ggplot2)
...
```{r numsteps1block, echo=TRUE, eval=TRUE}
...
```{r timeseries1block, echo=TRUE, eval=TRUE}
...
```{r maxstepsblock, echo=TRUE, eval=TRUE}
...
```{r numbNAblock, echo=TRUE, eval=TRUE}
...
```{r imputeblock, echo=TRUE, eval=TRUE}
data_imp = data
...
```{r recomputeblock, echo=TRUE, eval=TRUE}
...
```{r weekpartblock, echo=TRUE, eval=TRUE}
